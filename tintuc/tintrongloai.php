...
<body class="bg-light style-default style-rounded">
    <main class="main oh" id="main">
                ...
                <div class="col-md-6">
                    <article class="entry card">
                        <div class="entry__img-holder card__img-holder">
                            ...
                            <a href="#" class="entry__meta-category entry__meta-category--label entry__meta-category--align-in-corner entry__meta-category--violet"><?= $loaitin['Ten'] ?></a>
                        </div>
        ...
        <!-- Pagination -->
        <nav class="pagination" style="margin:0px 0px 1rem 0px; padding:0">
            <?php
